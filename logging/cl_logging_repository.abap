class CL_LOGGING_REPOSITORY definition
  public
  inheriting from CL_OBJECT
  final
  create private

  global friends CL_LOGGING_RESOURCE .

public section.

*"* public components of class CL_LOGGING_REPOSITORY
...
protected section.
*"* protected components of class CL_LOGGING_REPOSITORY
*"* do not include other source files here!!!
private section.
*"* private components of class CL_LOGGING_REPOSITORY
*"* do not include other source files here!!!
ENDCLASS.



CLASS CL_LOGGING_REPOSITORY IMPLEMENTATION.


* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method CL_LOGGING_REPOSITORY->IF_LOGGING_REPOSITORY~CREATE
* +-------------------------------------------------------------------------------------------------+
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method CL_LOGGING_REPOSITORY->IF_LOGGING_REPOSITORY~FIND_BY_ID
* +-------------------------------------------------------------------------------------------------+
...
* <SIGNATURE>---------------------------------------------------------------------------------------+
* | Instance Public Method CL_LOGGING_REPOSITORY->IF_LOGGING_REPOSITORY~UPDATE
* +-------------------------------------------------------------------------------------------------+
* | [--->] LOG_NUMBER                     TYPE        BALOGNR
