class CL_HTTP_MIME_TYPES definition
  public
...
*"* public components of class CL_HTTP_MIME_TYPES
...
protected section.
*"* protected components of class CL_HTTP_MIME_TYPES
*"* do not include other source files here!!!
private section.
*"* private components of class CL_HTTP_MIME_TYPES
*"* do not include other source files here!!!
ENDCLASS.



CLASS CL_HTTP_MIME_TYPES IMPLEMENTATION.
ENDCLASS.
