class CL_HTTP_STATUS_CODES definition
  public
...
*"* public components of class CL_HTTP_STATUS_CODES
...
protected section.
*"* protected components of class CL_HTTP_STATUS_CODES
*"* do not include other source files here!!!
private section.
*"* private components of class CL_HTTP_STATUS_CODES
*"* do not include other source files here!!!
ENDCLASS.



CLASS CL_HTTP_STATUS_CODES IMPLEMENTATION.
ENDCLASS.
